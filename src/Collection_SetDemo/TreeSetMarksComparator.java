 ...
 */
public class TreeSetMarksComparator {
	public static void main(String[] args) {

		TreeSet<StudentForComparator> ts = new TreeSet<StudentForComparator>(new StudentMarksComparator());
...
//		System.out.println(ts);		// CCE
		...
		System.out.println("Student sorted (ascending) on basis of Marks: ");
